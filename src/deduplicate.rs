...
/// inputs are sorted. It strictly requires sorted input to function correctly.
/// Unsorted input will result in incorrect results. It is the caller's responsibility
