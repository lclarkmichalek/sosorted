...
impl Bitmap {
    ...
    /// The input must be sorted in ascending order; providing unsorted input results in incorrect results or data loss, rather than strict memory-safety undefined behavior.
    ///
    /// # Examples
    ///
    /// ```
