...
impl Bitmap {
    ...
    /// The input must be sorted in ascending order; providing unsorted inputs results in incorrect behavior and invalid states, rather than memory-safety undefined behavior.
    ///
    /// # Examples
    ///
    /// ```
