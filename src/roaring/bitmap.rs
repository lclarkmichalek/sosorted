...
impl Bitmap {
    ...
    /// The input must be sorted in ascending order; providing unsorted inputs results in silent
    /// data loss as the internal `BTreeMap` overwrites existing containers, rather than strict
