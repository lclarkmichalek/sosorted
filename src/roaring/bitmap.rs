...
impl Bitmap {
    ...
    /// The input must be sorted in ascending order. This function relies on input being sorted
    /// by the high 16 bits; unsorted inputs causing interleaved high-bit chunks will result in
