...
impl Bitmap {
    ...
    /// The input must be sorted in ascending order; unsorted input results in incorrect behavior and invalid states, but will not cause memory-safety undefined behavior.
    ///
    /// # Examples
    ///
    /// ```
