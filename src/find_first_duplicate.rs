...
///
/// Note: This function strictly requires sorted input to function correctly, as it only checks adjacent elements for equality. Unsorted input results in partial detection.
///
/// # Examples
///
/// ```
