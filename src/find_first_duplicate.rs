...
/// Strictly requires sorted input to function correctly, as it only checks adjacent elements for equality; providing unsorted input results in partial detection rather than undefined behavior.
///
/// # Examples
///
/// ```
