...
///
/// **Note:** This function strictly requires the input to be sorted.
/// As it only checks adjacent elements for equality, unsorted input will
/// result in partial detection (only adjacent duplicates will be found).
///
/// # Examples
///
/// ```
