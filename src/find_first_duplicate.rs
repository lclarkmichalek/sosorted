...
///
/// **Important:** The input slice *must* be sorted. This function works by
/// comparing adjacent elements. If the input is not sorted, it will only
/// detect adjacent duplicates, not all duplicated values in the slice.
///
/// # Examples
///
/// ```
