...
/// inputs are sorted. It strictly requires sorted input to function correctly, as it
/// only checks adjacent elements for equality. Unsorted input results in partial
/// detection (only adjacent duplicates). It is the caller's responsibility to guarantee
/// sorted inputs.
///
/// # Examples
///
