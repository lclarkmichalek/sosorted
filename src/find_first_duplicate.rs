...
/// Strictly requires sorted input to function correctly; providing unsorted input results in partial detection rather than undefined behavior, as it only checks adjacent elements for equality.
///
/// # Examples
///
/// ```
