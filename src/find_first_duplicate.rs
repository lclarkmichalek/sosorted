...
/// Returns the index of the second occurrence of the first duplicate pair found. If there are no
/// duplicates, the length of the slice is returned. This function uses SIMD optimizations.
///
/// # Examples
///
/// ```
